...
{
    public partial class pkus : Form
    {
        ...
        private void pkus_Load(object sender, EventArgs e)
        {
        ...
        {
            komut = new SqlCommand("Select mamaresim,mamaisim,mamafiyat,mamalink from kus where tur='papagan' and marka='EUROGOLD'", baglantı);
        ...
        {
            komut = new SqlCommand("Select mamaresim,mamaisim,mamafiyat,mamalink from kus where tur='papagan' and marka='GOLDWINGS'", baglantı);
            adp = new SqlDataAdapter(komut);
            DataSet ds = new DataSet();
            adp.Fill(ds, "kus");
            dataGridView1.DataSource = ds;
        ...
        {
            komut = new SqlCommand("Select mamaresim,mamaisim,mamafiyat,mamalink from kus where tur='papagan' and marka='QUIK'", baglantı);
            adp = new SqlDataAdapter(komut);
            DataSet ds = new DataSet();
            adp.Fill(ds, "kus");
            dataGridView1.DataSource = ds;
        ...
        {
            komut = new SqlCommand("Select mamaresim,mamaisim,mamafiyat,mamalink from kus where tur='papagan' and marka='VITAKRAFT'", baglantı);
            adp = new SqlDataAdapter(komut);
            DataSet ds = new DataSet();
            adp.Fill(ds, "kus");
            dataGridView1.DataSource = ds;
